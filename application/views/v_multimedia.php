    ...
    <div class="container">
        ...
        <?php foreach ($tampil_multimedia as $multimedia) { ?>
            <div class="col-md-3 colmultimed">
                ...
                <p class="dsc"><b><?php $cetak = substr($multimedia->video_name,0,30);If($multimedia->video_name == $cetak) {echo $cetak;}else {echo "$cetak...";}?></b><br><?=$multimedia->name;?> | <?=date("Y.m.d", strtotime($multimedia->video_release_date));?></p>
            </div>
        <?php } ?>
        </div>
        <hr>
