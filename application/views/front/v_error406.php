...
<html lang="en">
    ...
    <style>
        ...
        button{
            border:.2rem solid rgb(182,45,45); outline:none !important; padding:1.05rem 1.75rem; font:400 1.45rem 'Roboto'; letter-spacing:.04rem; 
            color:white; background-color:rgb(182,45,45); transition:.2s all;
        }
