    ...
    <div class="container-fluid">
        ...
        <?php foreach ($tampil_multimedia as $multimedia) { ?>
            <div class="col-lg-3 col-md-6 colmultimed">
                <div class="tmcov">
                    <img src="http://img.youtube.com/vi/<?=$multimedia->link?>/0.jpg" class="thumb lazyload" onclick="myFunction(this)" alt="https://www.youtube.com/embed/<?=$multimedia->link;?>" id="<b><?=$multimedia->video_name;?></b><br><?=$multimedia->name;?> | <?=date("Y.m.d", strtotime($multimedia->release_date));?>">
                </div>
                <p class="dsc">
